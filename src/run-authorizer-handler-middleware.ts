...
// import { APIGatewayAuthorizerEvent, APIGatewayAuthorizerResult, APIGatewaySimpleAuthorizerWithContextResult, Context } from 'aws-lambda';
...
//  * TODO: doc me!
//  *
//  * @param err - TODO: doc me!
//  * @param res - TODO: doc me!
//  * @param status - TODO: doc me!
//  */
 ...
 *
 * @param serverlessOptions - TODO: doc me!
...
export function createRunAuthorizerHandlerMiddleware(
  ...
  return function runAuthorizerHandlerMiddleware(/* req: Request, res: Response, next: NextFunction */): void {
    ...
    if (authorizerHandler.length <= 2) {
      ...
      //         if (
      //           statement.find((statement: any) => {
      //             return (
      //               statement.Action === 'execute-api:Invoke' &&
      //               (((Array.isArray(statement.NotResource)
      //                 ? (statement.NotResource as string[]).includes(authorizerEvent.methodArn)
      //                 : statement.NotResource === authorizerEvent.methodArn) &&
      //                 statement.Effect === 'Allow') ||
      //                 ((Array.isArray(statement.NotResource)
      //                   ? (statement.NotResource as string[]).includes(tokenAuthorizerEvent.methodArn)
      //                   : statement.NotResource === authorizerEvent.methodArn) &&
